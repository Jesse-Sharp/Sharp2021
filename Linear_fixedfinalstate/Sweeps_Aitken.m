...
%  
%Performs the FBSM with the Aitken method for a given guess theta of Lambda(end) 
...
while Err > tol
    ...
    for i = 2:m+1
        [~,~,Xn] = FBSM(y0,X(:,i),parameters); %Solve system with updated control to obtain next control value
