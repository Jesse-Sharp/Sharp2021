...
%  
function [Control,Fevals] = Linear_Wegstein(tol,MaxFevals,nth,bounding,lower,upper)
...
while Err > tol
    ...
    %%To view the solution as it converges, uncomment this block (line 103 to line 117)
    %%to produce interim figures
%     figure(1)
%     box on
%     [y,~,~] = FBSM(y0,Xn,parameters); %Compute state ODE based on most recent control
