...
%  
function [Sol,Fevals] = AML_FixedStateBothEnds_Steffensen(tol,MaxFevals,m)
...
parameters.omega = 0.4; %Portion of previous iteration's control maintained when updating control
parameters.tol = tol;
...
%Lambda(3,end).
[z1,Fevals]  = Sweeps_Steffensen(theta1,parameters); %Perform FBSM to convergence
...
%Lambda(3,end).
[z2,Fevals] = Sweeps_Steffensen(theta2,parameters);
...
[z,Fevals] = Sweeps_Steffensen(theta1,parameters);
