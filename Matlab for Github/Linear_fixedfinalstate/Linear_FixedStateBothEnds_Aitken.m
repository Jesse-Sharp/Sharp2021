...
%   
function [Sol,Fevals] = Linear_FixedStateBothEnds_Aitken(tol,MaxFevals,m)
...
%Lambda(end).
[z1,Fevals]  = Sweeps_Aitken(theta1,parameters);
...
while SecantErr > SecantTol
    ...
    [z,Fevals] = Sweeps_Aitken(theta1,parameters); %Solve system with updated theta1
