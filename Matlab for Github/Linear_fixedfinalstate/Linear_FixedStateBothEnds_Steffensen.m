...
%  
function [Sol,Fevals] = Linear_FixedStateBothEnds_Steffensen(tol,MaxFevals,m)
...
dt = parameters.dt;
parameters.N = floor(Tfinal/dt+1); %Number of nodes in time discretisation
...
%Lambda(end).
[z1,Fevals]  = Sweeps_Steffensen(theta1,parameters);
...
while SecantErr > SecantTol
    ...
    [z,Fevals] = Sweeps_Steffensen(theta1,parameters); %Solve system with updated theta1
