% Author: Jesse Sharp; Last Update: 02/02/2021
%  
function [Control,Fevals] = AML_Steffensen_BB(tol,MaxFevals,m,omega)
...
while Err > tol
    ...
    %%To view the solution as it converges, uncomment this block (line 84 to line 99)
    %%to produce interim figures
%     figure(1)
%     box on
%     [y,~,~] = FBSM_BB(y0,X(:,2),parameters); %Compute state ODE based on most recent control
